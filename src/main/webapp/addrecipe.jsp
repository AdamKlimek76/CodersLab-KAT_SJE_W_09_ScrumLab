                    ...
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7"><textarea  name="description" class="w-100 des  p-1" rows="5"></textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input  name="preparationTime" class="minutes" type="number" value="0">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            <div class="col-5 p-4">
                                <textarea  name="preparation" class="w-100 sposob p-1" rows="10"></textarea>
                            </div>
                            <div class="col-2"></div>

                            <div class="col-5 p-4">
                                <textarea name="ingredients" class="w-100 skladniki p-1" rows="10"></textarea>
                            </div>
                        </div>
